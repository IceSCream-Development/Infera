            ...
            NavigationBar (
                ...
                NavigationBarItem(
                    ...
                    colors = NavigationBarItemDefaults.colors(
                        ...
                        // You might also want to adjust icon and text colors for contrast
                        selectedIconColor = Color(0xFF3EA711), // Example: If indicatorColor is light
                        selectedTextColor = Color(0xFF3EA711),   // Example
                        unselectedIconColor = MaterialTheme.colorScheme.onSurfaceVariant, // Default or your choice
                ...
                NavigationBarItem(
                    ...
                    icon = {
                        Icon(
                            painter = painterResource(id = R.drawable.icon_lecciones),
                            contentDescription = "Aprende",
                            modifier = Modifier.size(36.dp)
                                .background(color = Color.Transparent)
                        )
